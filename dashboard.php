        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>PAYROLL SYSTEM</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href="data_jabatan.php"><i class="fa fa-laptop"></i> Data Jabatan <span class="label label-success pull-right"></span></a>
                </li>
