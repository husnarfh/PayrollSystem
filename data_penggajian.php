                    ...
                    while($d=mysqli_fetch_array($sql)){
                      ...
                      ?>
                        ...
                        if(mysqli_num_rows($sql) > 0 ) {
                          echo "
                            <center>
                            <a class='btn btn-success' href='laporan_penggajian.php?bulan=$bulan&tahun=$tahun' target='_blank'> <span class='glypicon glypicon-print'></span> Cetak Daftar Gaji Pegawai </a>
                            <a class='btn btn-warning' href='excel_laporan_penggajian.php?bulan=$bulan&tahun=$tahun' target='_blank'> <span class='glypicon glypicon-print'></span> Export to Excel </a>
                            </center>
                          ";
                          }
                        ?>
