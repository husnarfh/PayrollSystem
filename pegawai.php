            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <a href="/" button type="submit" class="btn btn-success">Tambah Data</a>
                    <table class="table">
                      <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <?php
                    include "connect.php";
                    $sql = mysqli_query($connect, "SELECT pegawai.*,jabatan.nama_jabatan,golongan.nama_golongan FROM 
                    pegawai INNER JOIN jabatan ON pegawai.kode_jabatan=jabatan.kode_jabatan INNER JOIN golongan ON pegawai.kode_golongan=golongan.kode_golongan ORDER BY pegawai.nama_pegawai ASC");
                    $no=1;
                    ...
                    while($d=mysqli_fetch_array($sql)){
                        ...
                        echo"<td>". $d[status] ."</td>";
                        echo"<td>". $d[jumlah_anak] ."</td>";
                        echo"<td>";
                        // echo"<a class="btn btn-warning btn-sm" href="/">"Edit"</a>"
