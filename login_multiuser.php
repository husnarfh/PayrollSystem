			...
			<div class="panel panel-primary">
				...
				<?php
					...
					if($user == '' || $pass==''){
						...
						include "connect.php";
						$admin = mysqli_query($connect,"SELECT * FROM admin WHERE username='$user' AND password='$p'");
						$pegawai = mysqli_query($connect,"SELECT * FROM pegawai WHERE nip='$user' AND password='$p'");
						$hitung_admin = mysqli_num_rows($admin);
						$hitung_pegawai = mysqli_num_rows($pegawai);
